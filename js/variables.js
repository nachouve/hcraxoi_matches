...
export const fgpURL = "https://sidgad.cloud/shared/portales_files/agenda_portales.php?cliente=fgpatinaxe&idm=1&id_temp=31";
export const FILTER_ONLY = "RAXOI";
export const WEEK_DAYS = ['Domingo', 'Luns', 'Martes', 'Mercores', 'Xoves', 'Venres', 'Sabado'];
